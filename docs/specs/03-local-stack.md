...
|---------------|--------------------------------------|-----------------------------------------------------|---------------------------------------------|--------|
| `vectorizer`  | `hivehub/vectorizer:3.6.0-fastembed` | `17001:15002` (REST), `17005:15503` (Thunder RPC)   | `vec-data:/data` (config), `vec-state:/.local/share/vectorizer` (real state — collections/vectors/auth) | `/health` (no compose healthcheck) |
