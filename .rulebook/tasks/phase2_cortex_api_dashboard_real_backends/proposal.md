...
The Electron GUI in `gui/` calls 12 `/v1/dashboard/*` endpoints on `cortex-api` (port 15011) and renders them as the operator dashboard. Right now every endpoint returns empty:
