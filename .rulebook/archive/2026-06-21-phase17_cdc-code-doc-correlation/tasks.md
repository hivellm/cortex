...
- [x] 3.10 Live eval gate moved to **phase0_live-eval-gates-rerank-phantomlink** (created before this was checked) — same live-stack + golden-set dependency. Verifier code + 15 unit tests + flag-first config are complete here.
