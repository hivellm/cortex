...
//!
//! Same shape as [`cortex_graph::worker`] and [`cortex_embedder::worker`]
...
use crate::indexer::FulltextIndexer;
use crate::meili_client::MeiliError;
...
impl Worker {
    ...
    async fn publish_report(&self, events: &[EnrichedEvent], report: &crate::indexer::IndexReport) {
