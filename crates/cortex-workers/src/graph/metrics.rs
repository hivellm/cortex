...
impl Metrics {
    ...
    pub fn render_prom(&self) -> String {
        ...
        out.push_str("# TYPE cortex_graph_jobs_processed_total counter\n");
        let _ = writeln!(
            out,
            "cortex_graph_jobs_processed_total {}",
            self.jobs_processed_total()
        );
        out.push_str("# TYPE cortex_graph_last_job_ts_ms gauge\n");
        let _ = writeln!(out, "cortex_graph_last_job_ts_ms {}", self.last_job_ts_ms());
        out.push_str("# TYPE cortex_graph_edges_dropped_total counter\n");
        let _ = writeln!(
            out,
