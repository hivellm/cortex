...
pub fn build(now: DateTime<Utc>) -> Vec<SynthEnvelope> {
    ...
    let pii_pattern: &[Option<PiiRisk>] = &[
        ...
        None, None, None, None, None, None, None, None, None, None,
        None, None, None, None, None, None, None, None, None, None,
        Some(PiiRisk::Low), Some(PiiRisk::Low), Some(PiiRisk::Low),
        Some(PiiRisk::Low), Some(PiiRisk::Low), Some(PiiRisk::Low),
        Some(PiiRisk::Low), Some(PiiRisk::Low), Some(PiiRisk::Low),
        Some(PiiRisk::Low), Some(PiiRisk::Low), Some(PiiRisk::Low),
        Some(PiiRisk::Low), Some(PiiRisk::Low), Some(PiiRisk::Low),
        ...
        Some(PiiRisk::Low), Some(PiiRisk::Low), Some(PiiRisk::Low),
        Some(PiiRisk::Low),
        Some(PiiRisk::Medium), Some(PiiRisk::Medium), Some(PiiRisk::Medium),
        Some(PiiRisk::Medium), Some(PiiRisk::Medium), Some(PiiRisk::Medium),
        Some(PiiRisk::Medium), Some(PiiRisk::Medium), Some(PiiRisk::Medium),
        Some(PiiRisk::Medium),
        Some(PiiRisk::High), Some(PiiRisk::High), Some(PiiRisk::High),
        Some(PiiRisk::High), Some(PiiRisk::High),
    ];
