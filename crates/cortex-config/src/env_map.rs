...
pub const KNOWN_ENV_NAMES: &[(&str, &str)] = &[
    ...
    ("CORTEX_ARCHIVE_REFRESH_SECS", "/dashboard/archive_refresh_secs"),
    ("CORTEX_ARCHIVE_ROOT", "/ingestion/archive_root"),
    ("CORTEX_ARCHIVE_ZSTD", "/ingestion/archive_zstd_level"),
    ("CORTEX_EMBEDDER_COLLECTION_PREFIX", "/embedder/collection_prefix"),
    ("CORTEX_EMBEDDER_SYNAP_URL", "/embedder/synap_url"),
    ("CORTEX_EMBEDDER_VECTORIZER_PASSWORD", "/embedder/vectorizer_password"),
    ("CORTEX_EMBEDDER_VECTORIZER_URL", "/embedder/vectorizer_url"),
    ("CORTEX_EMBEDDER_VECTORIZER_USER", "/embedder/vectorizer_user"),
    ...
    ("CORTEX_RETENTION_FP32_TO_PQ_DAYS", "/retention/fp32_to_pq_days"),
    ("CORTEX_RETENTION_NOW", "/retention/now_override"),
    ("CORTEX_RETENTION_PQ_TO_BINARY_DAYS", "/retention/pq_to_binary_days"),
