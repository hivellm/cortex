...
mod tests {
    ...
    fn node_kind_round_trips() {
        let all = [
            ...
            NodeKind::Config, NodeKind::Document, NodeKind::Service, NodeKind::Table,
            NodeKind::Endpoint, NodeKind::Pipeline, NodeKind::Schema, NodeKind::Resource,
            NodeKind::Article, NodeKind::Entity, NodeKind::Topic, NodeKind::Claim,
            NodeKind::Source,
            NodeKind::Session, NodeKind::Turn, NodeKind::ToolCall, NodeKind::AgentCall,
            NodeKind::Memory, NodeKind::Decision, NodeKind::Analysis, NodeKind::Law,
            NodeKind::LawViolation, NodeKind::Artifact, NodeKind::Repo, NodeKind::Symbol,
            NodeKind::DocSection, NodeKind::ExternalPackage, NodeKind::UnresolvedImport,
            NodeKind::Knowledge, NodeKind::Learning, NodeKind::Consolidation,
            NodeKind::TopicCard, NodeKind::Model, NodeKind::Tool, NodeKind::User,
        ];
        for kind in all {
