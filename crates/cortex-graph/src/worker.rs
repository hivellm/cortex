...
//! [`cortex_embedder::worker`] — same `OffsetTracker`,
...
use crate::nexus_client::GraphClientError;
use crate::patch::{GraphPatch, NodeOp};
...
impl Worker {
    ...
    async fn publish_report(
        ...
        report: &crate::patch::GraphWriteReport,
    ) {
