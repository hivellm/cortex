//! Cortex bootstrap CLI library (was crate `cortex-bootstrap`).
//!
//! Walks existing Hive repos and republishes their content as
//! synthetic events on `cortex.events.bootstrap`. See
//! `docs/specs/09-bootstrap-cli.md`.
