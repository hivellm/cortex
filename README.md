...
|------------------|--------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|
| **Capture**      | Hooks in Claude Code / Cursor / Codex / Gemini publish events (prompts, tool calls, decisions).   | [10](docs/specs/10-claude-code-adapter.md), [17](docs/specs/17-additional-adapters.md) |
